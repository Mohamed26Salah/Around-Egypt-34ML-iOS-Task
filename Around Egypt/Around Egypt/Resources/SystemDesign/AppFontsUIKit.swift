...
//    case BodyXSmallRegular
    ...
    var font: UIFont {
        switch self {
        case .Heading1: return UIFont(name: "Gotham-Bold", size: 40) ?? UIFont.systemFont(ofSize: 40, weight: .bold)
        case .Heading2: return UIFont(name: "Gotham-Bold", size: 32) ?? UIFont.systemFont(ofSize: 40, weight: .bold)
        case .Heading3: return UIFont(name: "Gotham-Bold", size: 24) ?? UIFont.systemFont(ofSize: 40, weight: .bold)
        case .Heading4: return UIFont(name: "Gotham-Bold", size: 20) ?? UIFont.systemFont(ofSize: 40, weight: .bold)
        case .Heading5: return UIFont(name: "Gotham-Bold", size: 18) ?? UIFont.systemFont(ofSize: 40, weight: .bold)
        case .Heading6: return UIFont(name: "Gotham-Bold", size: 16) ?? UIFont.systemFont(ofSize: 40, weight: .bold)
...
//        case .BodyLargeSemiBold: return UIFont(name: "SF Pro Display Semibold", size: 16) ?? UIFont.systemFont(ofSize: 16, weight: .semibold)
        case .BodyLargeMedium: return UIFont(name: "Gotham-Medium", size: 16) ?? UIFont.systemFont(ofSize: 16, weight: .medium)
//        case .BodyLargeRegular: return UIFont(name: "SF Pro Display Regular", size: 16) ?? UIFont.systemFont(ofSize: 16, weight: .regular)
            
        case .BodyMediumBold: return UIFont(name: "Gotham-Bold", size: 14) ?? UIFont.systemFont(ofSize: 14, weight: .bold)
//        case .BodyMediumSemiBold: return UIFont(name: "SF Pro Display Semibold", size: 14) ?? UIFont.systemFont(ofSize: 14, weight: .semibold)
        case .BodyMediumMedium: return UIFont(name: "Gotham-Medium", size: 14) ?? UIFont.systemFont(ofSize: 14, weight: .medium)
//        case .BodyMediumRegular: return UIFont(name: "SF Pro Display Regular", size: 14) ?? UIFont.systemFont(ofSize: 14, weight: .regular)
            
        case .BodySmallBold: return UIFont(name: "Gotham-Bold", size: 12) ?? UIFont.systemFont(ofSize: 12, weight: .bold)
//        case .BodySmallSemiBold: return UIFont(name: "SF Pro Display Semibold", size: 12) ?? UIFont.systemFont(ofSize: 12, weight: .semibold)
        case .BodySmallMedium: return UIFont(name: "Gotham-Medium", size: 12) ?? UIFont.systemFont(ofSize: 12, weight: .medium)
//        case .BodySmallRegular: return UIFont(name: "SF Pro Display Regular", size: 12) ?? UIFont.systemFont(ofSize: 12, weight: .regular)
            
        case .BodyXSmallBold: return UIFont(name: "Gotham-Medium", size: 10) ?? UIFont.systemFont(ofSize: 10, weight: .bold)
//        case .BodyXSmallSemiBold: return UIFont(name: "SF Pro Display Semibold", size: 10) ?? UIFont.systemFont(ofSize: 10, weight: .semibold)
        case .BodyXSmallMedium: return UIFont(name: "Gotham-Medium", size: 10) ?? UIFont.systemFont(ofSize: 10, weight: .medium)
